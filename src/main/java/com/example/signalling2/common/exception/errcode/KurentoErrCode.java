...
public enum KurentoErrCode implements ErrorCode {
    ...
    KMS_NO_ENDPOINT(HttpStatus.INTERNAL_SERVER_ERROR, "KMS can't create new webRtcEndpoint."),
    KMS_RESTORE_ENDPOINT(HttpStatus.INTERNAL_SERVER_ERROR, "KMS can't restore webRtcEndpoint."),
    KMS_RESTORE_PIPELINE(HttpStatus.INTERNAL_SERVER_ERROR, "KMS can't restore media pipeline."),
